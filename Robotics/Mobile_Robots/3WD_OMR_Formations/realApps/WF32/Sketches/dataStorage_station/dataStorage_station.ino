...
const unsigned int varQty = 12*Robots_Qty + 1;                           // Quantity of state varaibles that must be saved.
...
void loop(){
  ...
  if(UART4.identifier == 0 && flagcommand_0){
    ...
    snprintf(measurements,bufferSize_0,"%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s;",UART4.MAT3.data[0][0],UART4.MAT3.data[0][1],UART4.MAT3.data[0][2],UART4.MAT3.data[0][3],UART4.MAT3.data[0][4],UART4.MAT3.data[0][5],UART4.MAT3.data[0][6],UART4.MAT3.data[0][7],UART4.MAT3.data[0][8],UART4.MAT3.data[0][9],UART4.MAT3.data[0][10],UART4.MAT3.data[0][11],UART4.MAT3.data[0][12],UART4.MAT3.data[0][13],UART4.MAT3.data[0][14],UART4.MAT3.data[0][15],UART4.MAT3.data[0][16],UART4.MAT3.data[0][17],UART4.MAT3.data[0][18],UART4.MAT3.data[0][19],UART4.MAT3.data[0][20],UART4.MAT3.data[0][21],UART4.MAT3.data[0][22],UART4.MAT3.data[0][23],UART4.MAT3.data[0][24]);
