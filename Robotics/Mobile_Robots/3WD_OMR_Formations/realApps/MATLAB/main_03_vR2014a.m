...
while true
    ...
    if isempty(data_r)
        ...
        if (isempty(command) == 0) && (command == 9) && (flag_1 == 0)
            ...
            data_s = sprintf(':0,%1.4f,%1.4f,%1.4f,%1.4f,%1.4f,%1.4f;',(1500 - positions(1,1)),(1400 + positions(1,3)),(1.52 + angles(1,2)),(1500 - positions(2,1)),(1400 + positions(2,3)),(1.075 + angles(2,2)));
