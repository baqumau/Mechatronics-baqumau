...
V1 = [-par.EKFcons01, -par.EKFcons01, par.EKFcons02;...
       par.EKFcons03, -par.EKFcons03,             0;...
       par.EKFcons04,  par.EKFcons04, par.EKFcons04]*(sys(4:6,1) - x(4:6,1));                                         % Input U_1.
V2 = [-par.EKFcons05, -par.EKFcons05, par.EKFcons06;...
       par.EKFcons07, -par.EKFcons07,             0;...
       par.EKFcons08,  par.EKFcons08, par.EKFcons08]*(sys(22:24,1) - x(22:24,1));                                     % Input U_2.
%---------------------------------Prediction-------------------------------
Ob_1 = V1(3,1) + x(18,1);
Ob_2 = V2(3,1) + x(36,1);
%-----------------------------------
...
%-----------------------------------
Pb_1 = [cosOb_1, -sinOb_1;...
        sinOb_1,  cosOb_1]*V1(1:2,1) + x(16:17,1);
Pb_2 = [cosOb_2, -sinOb_2;...
...
%-----------------------------------
F1 = [1, 0, -sOb_1V1_11_p_cOb_1V1_21;...
      0, 1,  cOb_1V1_11_m_sOb_1V1_21;...
      0, 0,                        1];
F2 = [1, 0, -sOb_2V2_11_p_cOb_2V2_21;...
      0, 1,  cOb_2V2_11_m_sOb_2V2_21;...
      0, 0,                        1];
G1 = [cosOb_1, -sinOb_1, -sOb_1V1_11_p_cOb_1V1_21;...
      sinOb_1,  cosOb_1,  cOb_1V1_11_m_sOb_1V1_21;...
            0,        0,                        1];
G2 = [cosOb_2, -sinOb_2, -sOb_2V2_11_p_cOb_2V2_21;...
...
sys(16:18,1) = [Pb_1;Ob_1] + L1*(u(7:8,1) - Pb_1 + [b_1sinOb_1;-b_1cosOb_1]);
sys(34:36,1) = [Pb_2;Ob_2] + L2*(u(9:10,1) - Pb_2 + [b_2sinOb_2;-b_2cosOb_2]);
