...
for i = 1:j
    % Control law gains for cluster's position (with an uniformly distributed variation at 10%):
    [K,P] = charatioass(3,.85,20,3.5);                                      % Desired characteristic polynomial in the tracking error dynamics.
    lambda_2 = K(1,2) + K(1,2)*(.2 - abs(rand(1)/2.5)); lambda_1 = K(1,3) + K(1,3)*(.2 - abs(rand(1)/2.5)); lambda_0 = K(1,4) + K(1,4)*(.2 - abs(rand(1)/2.5));
    ...
    % Control law gains for cluster's orientations (with an uniformly distributed variation at 10%):
    ...
    % Control law gains for cluster's distance (with an uniformly distributed variation at 10%):
    ...
    par.alpha_1 = diag([K1(1,2)+K1(1,2)*(.2 - abs(rand(1)/2.5)) K1(1,2)+K1(1,2)*(.2 - abs(rand(1)/2.5)) K2(1,2)+K2(1,2)*(.2 - abs(rand(1)/2.5)) K1(1,2)+K1(1,2)*(.2 - abs(rand(1)/2.5)) K1(1,2)+K1(1,2)*(.2 - abs(rand(1)/2.5)) K2(1,2)+K2(1,2)*(.2 - abs(rand(1)/2.5))]);
    par.alpha_2 = diag([K1(1,3)+K1(1,3)*(.2 - abs(rand(1)/2.5)) K1(1,3)+K1(1,3)*(.2 - abs(rand(1)/2.5)) K2(1,3)+K2(1,3)*(.2 - abs(rand(1)/2.5)) K1(1,3)+K1(1,3)*(.2 - abs(rand(1)/2.5)) K1(1,3)+K1(1,3)*(.2 - abs(rand(1)/2.5)) K2(1,3)+K2(1,3)*(.2 - abs(rand(1)/2.5))]);
    par.alpha_3 = diag([K1(1,4)+K1(1,4)*(.2 - abs(rand(1)/2.5)) K1(1,4)+K1(1,4)*(.2 - abs(rand(1)/2.5)) K2(1,4)+K2(1,4)*(.2 - abs(rand(1)/2.5)) K1(1,4)+K1(1,4)*(.2 - abs(rand(1)/2.5)) K1(1,4)+K1(1,4)*(.2 - abs(rand(1)/2.5)) K2(1,4)+K2(1,4)*(.2 - abs(rand(1)/2.5))]);
    ...
    conSys_2robots_1_vR2014a
    % Starting simulation:
    SimOut = sim('conSys_2robots_1_vR2014a','SrcWorkspace','Current','StopTime', '120');
    % Storing data:
