...
marker create  &
   ...
   adams_id = 1  &
   location = -1.0E+04, -1.0E+04, -59.975  &
...
geometry create shape block  &
   ...
   diag_corner_coords = 2.0E+04, 2.0E+04, 10.0
!
geometry attributes  &
...
marker create  &
   ...
   adams_id = 567  &
   location = 632.7271046225, -67.7075339772, 3.841311497E-06  &
   orientation = 0.523598778, 2.1867005383, 1.9474986753E-08
!
marker attributes  &
   marker_name = .Robot_Formation_1.omniwheel_1.cm  &
   visibility = off
...
marker create  &
   ...
   orientation = 0.5235987756, 5.2741511947E-02, 0.0
!
marker attributes  &
   marker_name = .Robot_Formation_1.omniwheel_1.MARKER_315  &
   visibility = off
...
marker create  &
   ...
   adams_id = 569  &
   location = 614.8850513764, -78.0086550107, -2.8680772289E-06  &
...
marker create  &
   ...
   adams_id = 571  &
   location = 623.8060779673, -72.8580948557, 0.0  &
   orientation = 0.5235987756, 1.5699621183, 0.0
!
marker attributes  &
   marker_name = .Robot_Formation_1.Part1_banhxe.cm  &
   visibility = off  &
...
marker create  &
   ...
   adams_id = 575  &
   location = 623.7129235409, -51.6967466562, 36.0927785662  &
   orientation = 0.5235987756, 1.0999390631, 2.9787300393E-02
!
marker attributes  &
   marker_name = .Robot_Formation_1.roller_2.cm  &
   visibility = off
...
marker create  &
   ...
   adams_id = 587  &
   location = 653.1211868559, -102.6333528801, -2.1350410836  &
   orientation = 0.5235987756, 5.2741511947E-02, 0.2512310296
!
marker attributes  &
   marker_name = .Robot_Formation_1.roller_8.cm  &
   visibility = off
...
marker create  &
   ...
   adams_id = 601  &
   location = 594.4909690787, -43.0828368312, 2.1350410836  &
   orientation = 0.5235987756, 5.2741511947E-02, 5.6765039422
!
marker attributes  &
   marker_name = .Robot_Formation_1.roller_15.cm  &
   visibility = off
...
marker create  &
   ...
   adams_id = 605  &
   location = 612.2526276954, -73.846931982, 40.1999998502  &
   orientation = 0.5235987756, 1.4490049135, 7.8683390272E-03
!
marker attributes  &
   marker_name = .Robot_Formation_1.roller_17.cm  &
   visibility = off
...
marker create  &
   ...
   adams_id = 607  &
   location = 625.7482322103, -97.2220046806, 33.9577374826  &
   orientation = 0.5235987756, 2.1471366143, 4.0316445858E-02
!
marker attributes  &
   marker_name = .Robot_Formation_1.roller_18.cm  &
   visibility = off
...
marker create  &
   ...
   adams_id = 609  &
   location = 644.7135870199, -60.8002102562, 4.8968039883E-02  &
...
marker create  &
   ...
   orientation = 0.5235987746, 0.7702498069, 7.627620925E-10
!
marker attributes  &
   marker_name = .Robot_Formation_1.hex_nut_gradec_iso_2.cm  &
   visibility = off  &
...
marker create  &
   ...
   adams_id = 617  &
   location = 639.7740271053, -89.9231052853, 6.9497600469  &
   orientation = 2.0943951024, 1.5707963268, 6.2537301161
!
marker attributes  &
   marker_name = .Robot_Formation_1.socket_head_cap_screw_iso_1.cm  &
   visibility = off  &
...
marker create  &
   ...
   adams_id = 619  &
   location = 625.711331143, -65.5658013873, -23.1879626456  &
   orientation = 2.0943951024, 1.5707963268, 1.5001963322E-02
!
marker attributes  &
   marker_name = .Robot_Formation_1.socket_head_cap_screw_iso_1_2.cm  &
   visibility = off  &
...
marker create  &
   ...
   adams_id = 621  &
   location = 619.6926623922, -55.1411613169, 16.2382025987  &
   orientation = 2.0943951024, 1.5707963268, 6.2707837221
!
marker attributes  &
   marker_name = .Robot_Formation_1.socket_head_cap_screw_iso_1_3.cm  &
   visibility = off  &
...
marker create  &
   ...
   adams_id = 625  &
   location = 867.2728891181, -67.7075421877, 7.3378081118E-07  &
   orientation = 5.7595865879, 2.0582201089, 2.9947309105E-08
!
marker attributes  &
   marker_name = .Robot_Formation_1.omniwheel_1_2.cm  &
   visibility = off
...
marker create  &
   ...
   adams_id = 627  &
   location = 885.1149521563, -78.0086525158, -2.8367678025E-06  &
...
marker create  &
   ...
   orientation = 2.617993878, 5.2741511947E-02, 3.1415926536
!
marker attributes  &
   marker_name = .Robot_Formation_1.omniwheel_2_2.MARKER_265  &
   visibility = off
...
marker create  &
   ...
   adams_id = 629  &
   location = 876.1939220327, -72.8580948557, 0.0  &
   orientation = 2.617993878, 6.2980192894E-03, 3.1415926536
!
marker attributes  &
   marker_name = .Robot_Formation_1.Part1_banhxe_2.cm  &
   visibility = off  &
...
marker create  &
   ...
   adams_id = 667  &
   location = 855.2977365521, -60.7806071845, 4.8973189957E-02  &
   orientation = 5.759586583, 1.3436320617, 5.9173859604E-03
!
marker attributes  &
   marker_name = .Robot_Formation_1.Part3_banhxe_2.cm  &
   visibility = off  &
...
marker create  &
   ...
   orientation = 5.7595865324, 1.3236550149, 1.457545114E-10
!
marker attributes  &
   marker_name = .Robot_Formation_1.hex_nut_gradec_iso_4.cm  &
   visibility = off  &
...
marker create  &
   ...
   adams_id = 675  &
   location = 882.9886800116, -50.496940041, 6.9497600469  &
   orientation = 1.0471975512, 1.5707963268, 6.4991605584E-03
!
marker attributes  &
   marker_name = .Robot_Formation_1.socket_head_cap_screw_iso_1_4.cm  &
   visibility = off  &
...
marker create  &
   ...
   adams_id = 679  &
   location = 862.9073152985, -85.2788840094, 16.2382025987  &
   orientation = 4.1887902048, 1.5707963268, 1.5601987203
!
marker attributes  &
   marker_name = .Robot_Formation_1.socket_head_cap_screw_iso_1_6.cm  &
   visibility = off  &
...
marker create  &
   ...
   adams_id = 683  &
   location = 750.0000086226, 135.4150715523, 1.2249985865E-06  &
   orientation = 1.570796365, 1.2074663852, 2.2946698653E-08
!
marker attributes  &
   marker_name = .Robot_Formation_1.omniwheel_1_3.cm  &
   visibility = off
...
marker create  &
   ...
   adams_id = 685  &
   location = 749.9999949575, 156.0173068382, -4.1457722974E-06  &
   orientation = 1.5707962532, 2.7032710991, 6.2831852346
!
marker attributes  &
   marker_name = .Robot_Formation_1.omniwheel_2_3.cm  &
   visibility = off
...
marker create  &
   ...
   orientation = 4.7123889804, 5.2741511947E-02, 3.1415926536
!
marker attributes  &
   marker_name = .Robot_Formation_1.omniwheel_2_3.MARKER_229  &
   visibility = off
...
marker create  &
   ...
   adams_id = 695  &
   location = 788.7348587494, 135.2161897113, -11.8262723488  &
   orientation = 1.5707963268, 0.2963243385, 4.7128500196
!
marker attributes  &
   marker_name = .Robot_Formation_1.roller_40.cm  &
   visibility = off
...
marker create  &
   ...
   adams_id = 703  &
   location = 709.5563157023, 135.2161897113, -2.1350410836  &
   orientation = 4.7123889804, 5.2741511947E-02, 1.5707963268
!
marker attributes  &
   marker_name = .Robot_Formation_1.roller_44.cm  &
   visibility = off
...
marker create  &
   ...
   adams_id = 715  &
   location = 782.3540375702, 156.2161897113, -24.3611627987  &
   orientation = 1.5707963268, 0.6453901888, 4.6941735229
!
marker attributes  &
   marker_name = .Robot_Formation_1.roller_50.cm  &
   visibility = off
...
marker create  &
   ...
   adams_id = 725  &
   location = 749.9886800275, 121.5808040261, 4.8958208775E-02  &
   orientation = 1.5707962246, 1.3435664549, 5.9157713778E-03
!
marker attributes  &
   marker_name = .Robot_Formation_1.Part3_banhxe_3.cm  &
   visibility = off  &
...
marker create  &
   ...
   orientation = 1.5707963276, 1.3236552231, 1.4602497668E-10
!
marker attributes  &
   marker_name = .Robot_Formation_1.hex_nut_gradec_iso_7.cm  &
   visibility = off  &
...
marker create  &
   ...
   adams_id = 17  &
   location = 692.40338741, 33.2473006948, -0.7271628705  &
   orientation = 5.7668504503, 2.2590978787E-04, 0.0
!
marker attributes  &
   marker_name = .Robot_Formation_1.khung_duoi_1.MARKER_17  &
   visibility = off
...
marker create  &
   ...
   adams_id = 745  &
   location = 806.6963223292, -32.6823808709, 6.8760328927  &
   orientation = 1.0439682135, 1.5847010304, 7.5259138125E-03
!
marker attributes  &
   marker_name = .Robot_Formation_1.DC_12v_251rpm_2.cm  &
   visibility = off  &
...
marker create  &
   ...
   adams_id = 751  &
   location = 654.154491955, -37.4385715255, 7.0  &
   orientation = 2.0943951024, 1.5707963268, 2.7481573023E-02
!
marker attributes  &
   marker_name = .Robot_Formation_1.socket_head_cap_screw_iso_2_3.cm  &
   visibility = off  &
...
marker create  &
   ...
   adams_id = 757  &
   location = 845.845508045, -37.4385715255, 7.0  &
   orientation = 1.0471975512, 1.5707963268, 3.0880228703E-03
!
marker attributes  &
   marker_name = .Robot_Formation_1.socket_head_cap_screw_iso_2_6.cm  &
   visibility = off  &
...
marker create  &
   ...
   adams_id = 856  &
   location = -867.2728953775, -67.7075339772, 3.8413117138E-06  &
   orientation = 0.523598778, 2.1867007679, 1.9474992786E-08
!
marker attributes  &
   marker_name = .Robot_Formation_1.omniwheel_1_4.cm  &
   visibility = off
...
marker create  &
   ...
   adams_id = 858  &
   location = -885.1149486236, -78.0086550107, -2.8680775007E-06  &
...
marker create  &
   ...
   orientation = 0.5235987756, 5.2741511947E-02, 3.1415926536
!
marker attributes  &
   marker_name = .Robot_Formation_1.omniwheel_2_4.MARKER_409  &
   visibility = off
...
marker create  &
   ...
   adams_id = 860  &
   location = -876.1939220327, -72.8580948557, 0.0  &
   orientation = 0.5235987756, 3.0510763242E-03, 0.0
!
marker attributes  &
   marker_name = .Robot_Formation_1.Part1_banhxe_4.cm  &
   visibility = off  &
...
marker create  &
   ...
   adams_id = 890  &
   location = -905.5090309213, -43.0828368312, 2.1350410836  &
   orientation = 0.5235987756, 5.2741511947E-02, 0.2696235525
!
marker attributes  &
   marker_name = .Robot_Formation_1.roller_69.cm  &
   visibility = off
...
marker create  &
   ...
   adams_id = 898  &
   location = -855.2864129801, -60.8002102562, 4.8968039883E-02  &
   orientation = 0.5235985448, 1.7979607563, 6.2772684109
!
marker attributes  &
   marker_name = .Robot_Formation_1.Part3_banhxe_4.cm  &
...
marker create  &
   ...
   orientation = 0.5235987746, 0.7702489294, 7.6360009748E-10
!
marker attributes  &
   marker_name = .Robot_Formation_1.hex_nut_gradec_iso_11.cm  &
   visibility = off  &
...
marker create  &
   ...
   adams_id = 906  &
   location = -860.2259728947, -89.9231052853, 6.9497600469  &
   orientation = 2.0943951024, 1.5707963268, 6.2761474272
!
marker attributes  &
   marker_name = .Robot_Formation_1.socket_head_cap_screw_iso_1_10.cm  &
   visibility = off  &
...
marker create  &
   ...
   adams_id = 908  &
   location = -874.288668857, -65.5658013873, -23.1879626456  &
   orientation = 2.0943951024, 1.5707963268, 5.6721426699
!
marker attributes  &
   marker_name = .Robot_Formation_1.socket_head_cap_screw_iso_1_11.cm  &
   visibility = off  &
...
marker create  &
   ...
   adams_id = 910  &
   location = -880.3073376078, -55.1411613169, 16.2382025987  &
   orientation = 2.0943951024, 1.5707963268, 3.9685768851E-02
!
marker attributes  &
   marker_name = .Robot_Formation_1.socket_head_cap_screw_iso_1_12.cm  &
   visibility = off  &
...
marker create  &
   ...
   adams_id = 914  &
   location = -632.7271110529, -67.7075423585, 6.1575156487E-07  &
   orientation = 5.7595865921, 2.0603448129, 3.1798608903E-08
!
marker attributes  &
   marker_name = .Robot_Formation_1.omniwheel_1_5.cm  &
   visibility = off
...
marker create  &
   ...
   orientation = 2.617993878, 5.2741511947E-02, 0.0
!
marker attributes  &
   marker_name = .Robot_Formation_1.omniwheel_1_5.MARKER_387  &
   visibility = off
...
marker create  &
   ...
   adams_id = 916  &
   location = -614.8850478437, -78.0086525158, -2.836767564E-06  &
...
marker create  &
   ...
   adams_id = 918  &
   location = -623.8060779673, -72.8580948557, 0.0  &
   orientation = 5.7595865316, 1.5732780717, 0.0
!
marker attributes  &
   marker_name = .Robot_Formation_1.Part1_banhxe_5.cm  &
   visibility = off  &
...
marker create  &
   ...
   adams_id = 956  &
   location = -644.7022634479, -60.7806071845, 4.8973189957E-02  &
   orientation = 5.759586583, 1.3436320617, 5.9173859604E-03
!
marker attributes  &
   marker_name = .Robot_Formation_1.Part3_banhxe_5.cm  &
...
marker create  &
   ...
   orientation = 5.7595865324, 1.3236550174, 1.4576462915E-10
!
marker attributes  &
   marker_name = .Robot_Formation_1.hex_nut_gradec_iso_13.cm  &
   visibility = off  &
...
marker create  &
   ...
   adams_id = 964  &
   location = -617.0113199884, -50.496940041, 6.9497600469  &
   orientation = 1.0471975512, 1.5707963268, 6.2771787329
!
marker attributes  &
   marker_name = .Robot_Formation_1.socket_head_cap_screw_iso_1_13.cm  &
   visibility = off  &
...
marker create  &
   ...
   adams_id = 966  &
   location = -631.0740159506, -74.854243939, -23.1879626456  &
   orientation = 4.1887902048, 1.5707963268, 1.5283378152
!
marker attributes  &
   marker_name = .Robot_Formation_1.socket_head_cap_screw_iso_1_14.cm  &
   visibility = off  &
...
marker create  &
   ...
   adams_id = 968  &
   location = -637.0926847015, -85.2788840094, 16.2382025987  &
   orientation = 1.0471975512, 1.5707963268, 0.1151751148
!
marker attributes  &
   marker_name = .Robot_Formation_1.socket_head_cap_screw_iso_1_15.cm  &
   visibility = off  &
...
marker create  &
   ...
   adams_id = 972  &
   location = -749.9999913774, 135.4150715523, 1.2249986197E-06  &
   orientation = 1.570796365, 1.207466643, 2.2946695161E-08
!
marker attributes  &
   marker_name = .Robot_Formation_1.omniwheel_1_6.cm  &
   visibility = off
...
marker create  &
   ...
   adams_id = 974  &
   location = -750.0000050425, 156.0173068382, -4.14577207E-06  &
   orientation = 1.5707962532, 2.7032710158, 6.2831852346
!
marker attributes  &
   marker_name = .Robot_Formation_1.omniwheel_2_6.cm  &
   visibility = off
...
marker create  &
   ...
   adams_id = 984  &
   location = -711.2651412506, 135.2161897113, -11.8262723488  &
   orientation = 1.5707963268, 0.2963243384, 4.7128879701
!
marker attributes  &
   marker_name = .Robot_Formation_1.roller_94.cm  &
   visibility = off
...
marker create  &
   ...
   adams_id = 992  &
   location = -790.4436842977, 135.2161897113, -2.1350410836  &
   orientation = 4.7123889804, 5.2741511946E-02, 1.5707963268
!
marker attributes  &
   marker_name = .Robot_Formation_1.roller_98.cm  &
   visibility = off
...
marker create  &
   ...
   adams_id = 1004  &
   location = -717.6459624298, 156.2161897113, -24.3611627987  &
   orientation = 4.7123889804, 2.4962024647, 3.0782780732
!
marker attributes  &
   marker_name = .Robot_Formation_1.roller_104.cm  &
   visibility = off
...
marker create  &
   ...
   adams_id = 1006  &
   location = -709.5563157023, 156.2161897113, 2.1350410836  &
   orientation = 4.7123889804, 5.2741511947E-02, 0.9867380577
!
marker attributes  &
   marker_name = .Robot_Formation_1.roller_105.cm  &
   visibility = off
...
marker create  &
   ...
   adams_id = 1014  &
   location = -750.0113199725, 121.5808040261, 4.8958208775E-02  &
   orientation = 1.5707962246, 1.3435664548, 5.9157713779E-03
!
marker attributes  &
   marker_name = .Robot_Formation_1.Part3_banhxe_6.cm  &
   visibility = off  &
...
marker create  &
   ...
   orientation = 1.5707963276, 1.3236551948, 1.4586307762E-10
!
marker attributes  &
   marker_name = .Robot_Formation_1.hex_nut_gradec_iso_16.cm  &
   visibility = off  &
...
marker create  &
   ...
   adams_id = 1034  &
   location = -693.3036776708, -32.6823808709, 6.8760328927  &
   orientation = 1.0439682135, 1.5847010304, 7.5259138142E-03
!
marker attributes  &
   marker_name = .Robot_Formation_1.DC_12v_251rpm_5.cm  &
   visibility = off  &
...
marker create  &
   ...
   adams_id = 1038  &
   location = -830.345508045, -64.2853590429, 7.0  &
   orientation = 2.0943951024, 1.5707963268, 2.1737690066E-03
!
marker attributes  &
   marker_name = .Robot_Formation_1.socket_head_cap_screw_iso_2_8.cm  &
   visibility = off  &
...
!
file parasolid read  &
   file_name = "twoRobotsPlant_1_v2020.xmt_txt"  &
   model_name = .Robot_Formation_1
!
geometry attributes  &
...
force create element_like friction  &
   ...
   friction_torque_preload = 1.0E-02  &
   effect = all  &
   preload = on  &
   reaction_force = on  &
   bending_moment = off  &
...
!
ude create instance  &
   instance_name = .Robot_Formation_1.twoRobotsPlant_1_v2020  &
   definition_name = .controls.controls_plant  &
   location = 0.0, 0.0, 0.0  &
   orientation = 0.0, 0.0, 0.0
!
ude create instance  &
   instance_name = .Robot_Formation_1.Cluster_6  &
   definition_name = .controls.controls_plant  &
   location = 0.0, 0.0, 0.0  &
   orientation = 0.0, 0.0, 0.0
!
...
!
variable modify  &
   variable_name = .Robot_Formation_1.twoRobotsPlant_1_v2020.input_channels  &
   object_value =   &
      .Robot_Formation_1.T_11,  &
      .Robot_Formation_1.T_12,  &
      .Robot_Formation_1.T_13,  &
...
!
variable modify  &
   variable_name = .Robot_Formation_1.twoRobotsPlant_1_v2020.output_channels  &
   object_value =   &
      .Robot_Formation_1.X_1,  &
      .Robot_Formation_1.Y_1,  &
      .Robot_Formation_1.O_1,  &
...
!
variable modify  &
   variable_name = .Robot_Formation_1.twoRobotsPlant_1_v2020.file_name  &
   string_value = "twoRobotsPlant_1_v2020"
!
variable modify  &
   variable_name = .Robot_Formation_1.twoRobotsPlant_1_v2020.event_name  &
   string_value = ""
!
variable modify  &
   variable_name = .Robot_Formation_1.twoRobotsPlant_1_v2020.solver_type  &
   string_value = "cplusplus"
!
variable modify  &
   variable_name = .Robot_Formation_1.twoRobotsPlant_1_v2020.target  &
   string_value = "MATLAB"
!
variable modify  &
   variable_name = .Robot_Formation_1.twoRobotsPlant_1_v2020.FMI_Master  &
   string_value = "none"
!
variable modify  &
   variable_name = .Robot_Formation_1.twoRobotsPlant_1_v2020.analysis_type  &
   string_value = "non_linear"
!
variable modify  &
   variable_name = .Robot_Formation_1.twoRobotsPlant_1_v2020.analysis_init  &
   string_value = "no"
!
variable modify  &
   variable_name = .Robot_Formation_1.twoRobotsPlant_1_v2020.analysis_init_str  &
   string_value = ""
!
variable modify  &
   variable_name = .Robot_Formation_1.twoRobotsPlant_1_v2020.user_lib  &
   string_value = ""
!
variable modify  &
   variable_name = .Robot_Formation_1.twoRobotsPlant_1_v2020.host  &
   string_value = "baqumau-PC"
!
variable modify  &
   variable_name = .Robot_Formation_1.twoRobotsPlant_1_v2020.dynamic_state  &
   string_value = "on"
!
variable modify  &
   variable_name = .Robot_Formation_1.twoRobotsPlant_1_v2020.tcp_ip  &
   string_value = "off"
!
variable modify  &
   variable_name = .Robot_Formation_1.twoRobotsPlant_1_v2020.output_rate  &
   integer_value = 1
!
variable modify  &
   variable_name = .Robot_Formation_1.twoRobotsPlant_1_v2020.realtime  &
   string_value = "off"
!
variable modify  &
   variable_name = .Robot_Formation_1.twoRobotsPlant_1_v2020.include_mnf  &
   string_value = "no"
!
variable modify  &
   variable_name = .Robot_Formation_1.twoRobotsPlant_1_v2020.hp_group  &
   object_value = (NONE)
!
variable modify  &
   variable_name = .Robot_Formation_1.twoRobotsPlant_1_v2020.pv_group  &
   object_value = (NONE)
!
variable modify  &
   variable_name = .Robot_Formation_1.twoRobotsPlant_1_v2020.gp_group  &
   object_value = (NONE)
!
variable modify  &
   variable_name = .Robot_Formation_1.twoRobotsPlant_1_v2020.pf_group  &
   object_value = (NONE)
!
variable modify  &
   variable_name = .Robot_Formation_1.twoRobotsPlant_1_v2020.ude_group  &
   object_value = (NONE)
!
ude modify instance  &
   instance_name = .Robot_Formation_1.twoRobotsPlant_1_v2020
...
!
variable modify  &
   variable_name = .Robot_Formation_1.Cluster_6.input_channels  &
   object_value =   &
      .Robot_Formation_1.T_11,  &
      .Robot_Formation_1.T_12,  &
      .Robot_Formation_1.T_13,  &
...
!
variable modify  &
   variable_name = .Robot_Formation_1.Cluster_6.output_channels  &
   object_value =   &
      .Robot_Formation_1.X_1,  &
      .Robot_Formation_1.Y_1,  &
      .Robot_Formation_1.O_1,  &
...
!
variable modify  &
   variable_name = .Robot_Formation_1.Cluster_6.file_name  &
   string_value = "Cluster_6"
!
variable modify  &
   variable_name = .Robot_Formation_1.Cluster_6.event_name  &
   string_value = ""
!
variable modify  &
   variable_name = .Robot_Formation_1.Cluster_6.solver_type  &
   string_value = "cplusplus"
!
variable modify  &
   variable_name = .Robot_Formation_1.Cluster_6.target  &
   string_value = "MATLAB"
!
variable modify  &
   variable_name = .Robot_Formation_1.Cluster_6.FMI_Master  &
   string_value = "none"
!
variable modify  &
   variable_name = .Robot_Formation_1.Cluster_6.analysis_type  &
   string_value = "non_linear"
!
variable modify  &
   variable_name = .Robot_Formation_1.Cluster_6.analysis_init  &
   string_value = "no"
!
variable modify  &
   variable_name = .Robot_Formation_1.Cluster_6.analysis_init_str  &
   string_value = ""
!
variable modify  &
   variable_name = .Robot_Formation_1.Cluster_6.user_lib  &
   string_value = ""
!
variable modify  &
   variable_name = .Robot_Formation_1.Cluster_6.host  &
   string_value = "baqumau-PC.mshome.net"
!
variable modify  &
   variable_name = .Robot_Formation_1.Cluster_6.dynamic_state  &
   string_value = "on"
!
variable modify  &
   variable_name = .Robot_Formation_1.Cluster_6.tcp_ip  &
   string_value = "off"
!
variable modify  &
   variable_name = .Robot_Formation_1.Cluster_6.output_rate  &
   integer_value = 1
!
variable modify  &
   variable_name = .Robot_Formation_1.Cluster_6.realtime  &
   string_value = "off"
!
variable modify  &
   variable_name = .Robot_Formation_1.Cluster_6.include_mnf  &
   string_value = "yes"
!
variable modify  &
   variable_name = .Robot_Formation_1.Cluster_6.hp_group  &
   object_value = (NONE)
!
variable modify  &
   variable_name = .Robot_Formation_1.Cluster_6.pv_group  &
   object_value = (NONE)
!
variable modify  &
   variable_name = .Robot_Formation_1.Cluster_6.gp_group  &
   object_value = (NONE)
!
variable modify  &
   variable_name = .Robot_Formation_1.Cluster_6.pf_group  &
   object_value = (NONE)
!
variable modify  &
   variable_name = .Robot_Formation_1.Cluster_6.ude_group  &
   object_value = (NONE)
!
ude modify instance  &
   instance_name = .Robot_Formation_1.Cluster_6
