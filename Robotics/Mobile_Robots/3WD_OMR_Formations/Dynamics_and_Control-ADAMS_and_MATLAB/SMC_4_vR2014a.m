function [sys,x0,str,ts,simStateCompliance] = SMC_4_vR2014a(t,x,u,flag,par)
...
%-----------------------------------
He_1 = (par.HGOcons03)*u(11)*[0 1 0;-1 0 0;0 0 0];
He_2 = (par.HGOcons08)*u(12)*[0 1 0;-1 0 0;0 0 0];
