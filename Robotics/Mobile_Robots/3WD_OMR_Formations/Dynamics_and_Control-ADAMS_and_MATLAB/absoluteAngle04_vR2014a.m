function Beta_c = absoluteAngle04_vR2014a(u)
...
if data_4.x >= 0 && data_4.x <= pi/2
    data_4.f1 = 1;
elseif data_4.x > pi/2 && data_4.x <= pi
    data_4.f1 = 2;
elseif data_4.x > -pi && data_4.x <= -pi/2
    data_4.f1 = 3;
else
    data_4.f1 = 4;
end
% Addition of 2*pi:
if data_4.f1 == 2 && data_4.f2 == 3
    data_4.j = data_4.j + 2;
end
if data_4.f1 == 1 && data_4.f2 == 3
    data_4.j = data_4.j + 2;
end
    
% Substraction of 2*pi:
if data_4.f1 == 3 && data_4.f2 == 2
    data_4.j = data_4.j - 2;
end
% Correction of angle:
Beta_c = data_4.j*pi + u;
