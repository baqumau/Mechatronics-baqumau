function [sys,x0,str,ts,simStateCompliance] = SMC_3_vR2014a(t,x,u,flag,par)
...
%-----------------------------------
He_1 = (par.HGOcons03)*(u(11)-u(9))*[0 1 0;-1 0 0;0 0 0];
He_2 = (par.HGOcons08)*(u(12)-u(9))*[0 1 0;-1 0 0;0 0 0];
...
%--------------------------------------------------------------------------
% Control laws:
sys(31:36,1) = -(Lambda_e_c\(Jin_c'*Be))\(-Lambda_e_c\(Jin_c'*He*Jin_c*u(7:12,1)) + dJ_dc_c*Jin_c*u(7:12,1) - u(25:30,1) + 2*par.dampFacts*par.Lambda*(u(7:12,1) - u(19:24,1)) + par.Lambda^2*(u(1:6,1) - u(13:18,1)) + K.*tanh(par.err*sigma) + diag([0 0 0 1 0 0])*u(31:36,1));
%--------------------------------------------------------------------------
% Sliding surfaces:
sys(37:42,1) = sigma;
% end mdlUpdate
