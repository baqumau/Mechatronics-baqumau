function [sys,x0,str,ts,simStateCompliance] = HGO_1_vR2014a(t,x,u,flag,par)
...
%--------------------------------------------------------------------------
b1_01 = par.delta_1 + x(9); b1_02 = par.delta_1 - x(9);
...
%-----------------------------------
b2_01 = par.delta_1 + x(12); b2_02 = par.delta_1 - x(12);
...
%--------------------------------------------------------------------------
sys(13:18,1) = - D\(H_dq*x(19:24,1) - B_q*u(1:6)) + (par.HGOcons12)*(u(7:12,1) - x(7:12)) + x(31:36);
