...
switch n
    case 1
        ...
        desired_path.signals.dimensions = 6;
    ...
    case 2
        ...
        dThc = (Vc/Rt)*ones(length(desired_path.time),1);                       % Initial condition of cluster orientation \theta_c(0) = -pi/4 rad.
    ...
    case 5
        ...
        desired_path.signals.dimensions = 18;
        % l_0 = sqrt(a1_0^2 + a2_0^2 + 2*a1_0*a2_0*cos(vth1_0));
        % x1_0 = xc_0 + l_0*sin(thc_0)/3;
        % y1_0 = yc_0 + l_0*cos(thc_0)/3;
        % x2_0 = x1_0 - a1_0*sin(vth1_0/2 + thc_0);
    ...
    case 11
        ...
        desired_path.signals.dimensions = 10;
    case 21
        ...
        desired_path.signals.dimensions = 14;
    case 22
    ...
    case 31
        ...
        desired_path.signals.dimensions = 4;
    ...
    case 41
        ...
        desired_path.signals.dimensions = 5;
    case 42
