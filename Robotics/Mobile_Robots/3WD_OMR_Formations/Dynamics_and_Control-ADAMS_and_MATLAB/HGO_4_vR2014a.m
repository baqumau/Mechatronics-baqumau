function [sys,x0,str,ts,simStateCompliance] = HGO_4_vR2014a(t,x,u,flag,par)
...
%--------------------------------------------------------------------------
H1_dc = (par.HGOcons03)*x(23)*[0 1 0;-1 0 0;0 0 0];
H2_dc = (par.HGOcons08)*x(24)*[0 1 0;-1 0 0;0 0 0];
