...
F2837xS_CodeStartBranch.obj: C:/ti/controlSUITE/device_support/F2837xS/v130/F2837xS_common/source/F2837xS_CodeStartBranch.asm $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	...
	"C:/ti/ccs1250/ccs/tools/compiler/c2000_6.2.11/bin/cl2000" -v28 -ml -mt --cla_support=cla1 --float_support=fpu32 --tmu_support=tmu0 --vcu_support=vcu2 --include_path="C:/ti/ccs1250/ccs/tools/compiler/c2000_6.2.11/include" --include_path="C:/ti/controlSUITE/device_support/F2837xS/v130/F2837xS_headers/include" --include_path="C:/ti/controlSUITE/device_support/F2837xS/v130/F2837xS_common/include" -g --define=CPU1 --define=_FLASH --diag_warning=225 --display_error_number --preproc_with_compile --preproc_dependency="F2837xS_CodeStartBranch.d_raw" $(GEN_OPTS__FLAG) "$<"
...
blinky_cpu01.obj: C:/ti/controlSUITE/device_support/F2837xS/v130/F2837xS_examples_Cpu1/blinky/cpu01/blinky_cpu01.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Building file: "$<"'
	@echo 'Invoking: C2000 Compiler'
	"C:/ti/ccs1250/ccs/tools/compiler/c2000_6.2.11/bin/cl2000" -v28 -ml -mt --cla_support=cla1 --float_support=fpu32 --tmu_support=tmu0 --vcu_support=vcu2 --include_path="C:/ti/ccs1250/ccs/tools/compiler/c2000_6.2.11/include" --include_path="C:/ti/controlSUITE/device_support/F2837xS/v130/F2837xS_headers/include" --include_path="C:/ti/controlSUITE/device_support/F2837xS/v130/F2837xS_common/include" -g --define=CPU1 --define=_FLASH --diag_warning=225 --display_error_number --preproc_with_compile --preproc_dependency="blinky_cpu01.d_raw" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: "$<"'
	@echo ' '
