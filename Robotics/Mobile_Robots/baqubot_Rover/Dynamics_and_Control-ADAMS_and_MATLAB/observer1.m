function [sys,x0,str,ts,simStateCompliance] = observer1(t,x,u,flag,par)
...
% Changing the coordinates of input torques:
tm = [1/par.r 1/par.r;-par.b/(2*par.r) par.b/(2*par.r)]*[u(2) u(1)]';
% Observer:
sys(1:3) = par.Aob1*x(1:3) + par.Bob1*[tm(1) u(3)]';
sys(4:6) = par.Aob2*x(4:6) + par.Bob2*[tm(2) u(4)]';
