function [sys,x0,str,ts,simStateCompliance] = observer1TC(t,x,u,flag,par)
...
% Observer:
sys(1:3) = par.Aob3*x(1:3) + par.Bob3*[u(4) u(1)]';
sys(4:6) = par.Aob4*x(4:6) + par.Bob4*[u(5) u(2)]';
sys(7:9) = par.Aob5*x(7:9) + par.Bob5*u(3);
