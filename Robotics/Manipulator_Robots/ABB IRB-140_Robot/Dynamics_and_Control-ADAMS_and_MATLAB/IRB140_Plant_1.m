...
ADAMS_cwd ='C:\Users\baqumau\Mechatronics-baqumau\Robotics\Manipulator_Robots\ABB IRB-140 Robot\Dynamics_and_Control - ADAMS_and_MATLAB'  ;
ADAMS_prefix = 'IRB140_Plant_1' ;
ADAMS_static = 'no' ;
ADAMS_solver_type = 'C++' ;
ADAMS_version = '2020' ;
...
ADAMS_init = '' ;
ADAMS_inputs  = 'Torque1!Torque2!Torque3!Torque4!Torque5!Torque6!Disturbance1!Disturbance2!Disturbance3' ;
ADAMS_outputs = 'Theta1!Theta2!Theta3!Theta4!Theta5!Theta6!dTheta1!dTheta2!dTheta3!dTheta4!dTheta5!dTheta6' ;
ADAMS_pinput = 'IRB140_Plant_1.ctrl_pinput' ;
ADAMS_poutput = 'IRB140_Plant_1.ctrl_poutput' ;
ADAMS_uy_ids  = [
                   13
                   14
                   15
